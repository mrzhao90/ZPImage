...
//
//@property(nonatomic,assign)CGFloat imageMatrixViewHeight;
//
...
@implementation AKImageMatrixView
...
//}
//
//+(instancetype)imageMatrixViewEdge:(AKEdge)edge imagesName:(NSArray<NSString*> *)imagesName playModel:(AKPlayModel)playModel{
//    AKImageMatrixView * imageMatrixView = [[AKImageMatrixView alloc]init];
//    imageMatrixView.edge = edge;
//    imageMatrixView.urls = imagesName;
//    imageMatrixView.playModel = playModel;
//
//    [imageMatrixView setUpSubViewsWithNetImage];
//
//    return imageMatrixView;
//}
//
//+(instancetype)imageMatrixViewEdge:(AKEdge)edge imageDatas:(NSArray<NSData*> *)imageDatas playModel:(AKPlayModel)playModel{
//    AKImageMatrixView * imageMatrixView = [[AKImageMatrixView alloc]init];
//    imageMatrixView.edge = edge;
//    imageMatrixView.imageDatas = imageDatas;
//    imageMatrixView.playModel = playModel;
//
//    [imageMatrixView setUpSubViewsWithLocalImage];
//
//    return imageMatrixView;
//}
//
...
//    self.imageMatrixViewHeight = list*imageWH + _edge.marginTB*(list+1);
//    return imageWH;
//}
//
...
//    if (!_isCompleted || _isAnimateing) { NSLog(@"稍等..."); return; }
//    [self loopPlayGifWithIndex:0];
//}
//
