...
@interface AKImageMatrixView : UIView

///**height of AKImageMatrixView */
//@property(nonatomic,assign,readonly)CGFloat imageMatrixViewHeight;
//
//
///**
// imageMatrixView
...
// @return imageMatrixView instance
// */
